...
export const metadata: Metadata = {
  metadataBase: new URL("https://carestaysuites.com"),
  title: "CareStay Suites | Furnished Stays for Professionals in Toronto",
  description: "Professionally managed furnished rentals in Toronto for business travel, relocations, healthcare assignments, insurance placements, and project stays.",
